...
class HypotheticalQuestionContentRetrieverTest {
    ...
    void should_deduplicate_by_original_text() {
        ...
        // given — two different questions pointing to the same original text
    ...
    void should_keep_max_score_when_deduplicating() {
        ...
        // given — second match has higher score
        TextSegment q1 =
        ...
        // then — should use the higher score
        assertThat(results).hasSize(1);
    ...
    void should_limit_results_to_maxResults() {
        ...
        // given — 3 different originals but maxResults=2
    ...
    void should_sort_results_by_score_descending() {
        ...
        // given — matches arrive in non-score order
    ...
    void should_not_deduplicate_same_original_text_from_different_sources() {
        ...
        assertThat(results.get(0).textSegment().metadata().getString("file_name")).isEqualTo("a.txt");
        assertThat(results.get(1).textSegment().text()).isEqualTo("Shared text.");
        assertThat(results.get(1).textSegment().metadata().getString("file_name")).isEqualTo("b.txt");
    }
