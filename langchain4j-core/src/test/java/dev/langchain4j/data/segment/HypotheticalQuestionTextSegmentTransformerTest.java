...
class HypotheticalQuestionTextSegmentTransformerTest {
    ...
    void should_skip_segment_when_chatmodel_returns_only_whitespace() {

        // given — ChatModel returns only whitespace lines (0 valid questions)
        ...
        // then — all lines are whitespace, so 0 valid questions, segment is filtered out
    ...
    void should_not_share_metadata_between_question_segments() {
        ...
        // then — modifying one segment's metadata should not affect the other
