 ...
 * from neighboring segments within the same document.
 * <br>
 ...
 * <br>
 * <br>
 * <b>Note:</b> This transformer processes all segments as a flat list. If segments from multiple
 * documents are passed together, the surrounding context window may span across document boundaries.
 * To avoid this, ingest documents separately or ensure that segments from different documents are
 * not mixed in the same {@code transformAll} call.
 * <br>
 * <br>
 * Example usage:
 * <pre>{@code
