...
public class HypotheticalQuestionTextSegmentTransformer implements TextSegmentTransformer {
     ...
     * @return a list of question segments. The list will be longer than the input list.
     */
    @Override
    public List<TextSegment> transformAll(List<TextSegment> segments) {
        ...
        for (TextSegment segment : segments) {
            ...
            for (String question : questions) {
                ...
                result.add(TextSegment.from(question, newMetadata));
            }
        }
        return result;
    }
    ...
    private String normalizeQuestion(String line) {
        ...
        String normalized = QUESTION_LIST_PREFIX_PATTERN.matcher(line.trim()).replaceFirst("").trim();
